import { Resolver, Query, Arg, FieldResolver, Root, Mutation, InputType, Field, Ctx, PubSub } from 'type-graphql';
...
export class NoteResolver {
  ...
  @Query((returns) => [Note])
  notes(@Arg('approvalId', (type) => String) approvalId: string): Promise<Note[]> {
